...
- Real AgentMail intake/reply, OpenAI extraction, Firecrawl evidence, deterministic verdict, and controlled delivery evidence is recorded on the development deployment.
