...
| 9   | in_progress | Production backend/static hosting, seeds, public smoke test, docs and submission package                  | Video/social/submission account actions   | Commit `889e2ec` deployed and smoke-tested; media/submission remain |

## Current sequence

1. Record the sub-three-minute product demo using the production hero case and controlled evidence already prepared.
2. Publish the social post and replace the remaining media placeholders with public URLs.
3. Complete the exact VibeApps submission form and preserve a timestamped confirmation.
